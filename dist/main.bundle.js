...
module.exports = "<h1> {{recipeObject.recipeTitle}}</h1>\n<h2> Ingredients: {{recipeObject.ingredients}} </h2>\n<h3> Instructions: {{recipeObject.instructions}} </h3>\n<b> Macronutrients </b>\n<p> Calories:{{recipeObject.calories}}</p>\n<p> Protein: {{recipeObject.protein}}<p>\n<p> Fat: {{recipeObject.fat}}</p>\n<p> Carbs: {{recipeObject.carbs}} </p>\n<p> Sugar: {{recipeObject.sugar}} </p>"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__recipe_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_IRecipeModel__ = __webpack_require__(36);
...
*/
    ...
    RecipeDetailsComponent.prototype.getResults = function () {
        var _this = this;
        this.id = this.route.snapshot.params.recipeId;
        console.log('get results:' + this.id);
        this.recipe$.getDetailsForRecipe(this.id).subscribe(function (result) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe_details_recipe_details_component__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__recipe_details_recipe_details_component__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_common__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_route__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__recipe_service__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__browse_table_table_component__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__recipe_details_detail_table_detail_table_component__ = __webpack_require__(99);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_IRecipeModel__ = __webpack_require__(36);
